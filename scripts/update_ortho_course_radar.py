...
SOURCES = [
    ...
    Source("AAOS", "國際", ("https://www.aaos.org/education/courses/",)),
    Source("OTA", "創傷", ("https://ota.org/education/person-events/meetings-and-courses",)),
    Source("NASS", "脊椎", ("https://www.spine.org/Education/Courses-Conferences",)),
    Source("ORS", "研究", ("https://www.ors.org/events/",)),
    Source("SICOT", "國際", ("https://www.sicot.org/events",)),
]
...
KEEP = re.compile(
    ...
    r"young surgeon|fellowship|workshop|course|camp|forum|meeting|congress|conference|"
...
def from_html(source: Source) -> list[dict[str, str]]:
    ...
    for page in pages:
        ...
        for a in soup.select("ul.pagination a[href]"):
            ...
            if href not in seen_pages and len(pages) < 5:
                pages.append(href)
